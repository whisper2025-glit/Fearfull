...
const EditCharacter = () => {
  ...
  // Load character data owned by current user
  useEffect(() => {
      ...
      <div className="min-h-screen bg-background">
        <div className="flex items-center justify-between p-4 border-b border-border">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="icon" onClick={() => navigate(-1)} className="text-primary hover:bg-primary/10">
          ...
          <Button size="sm" onClick={handleSave} disabled={isSaving || isLoading} className="bg-primary hover:bg-primary/90 text-white">
        ...
        <div className="flex bg-background">
          <Button
            ...
            className={`flex-1 rounded-none h-12 text-xs font-medium ${
              activeTab === 'edit' ? 'bg-primary text-white shadow-lg' : 'bg-black text-white hover:bg-secondary/30'
            }`}
          ...
          <Button
            variant="ghost"
            className={`flex-1 rounded-none h-12 text-xs font-medium ${
              activeTab === 'preview' ? 'bg-primary text-white shadow-lg' : 'bg-black text-white hover:bg-secondary/30'
            }`}
        ...
        <div className="max-w-lg mx-auto px-4 py-6 space-y-8">
          {isLoading ? (
            ...
            <>
              ...
              <div className="space-y-4">
                <Label className="text-primary text-sm font-medium">Gender <span className="text-primary">*</span></Label>
            ...
            <div className="text-center py-12 space-y-6">
              ...
              <div className="border-t border-border pt-6">
                ...
                <div className="text-xs text-muted-foreground leading-relaxed">
                  <MessageFormatter content={formData.intro || "Your OC's introduction"} className="text-xs leading-relaxed" />
                </div>
              </div>
              <div className="border-t border-border pt-6">
                ...
                <div className="bg-secondary/50 rounded-lg p-4 text-left">
                  <div className="text-xs text-muted-foreground leading-relaxed">
                    <MessageFormatter content={formData.greeting || "Please fill in the greetings column on the left"} className="text-xs leading-relaxed chat-text" />
                  </div>
                </div>
              </div>
              {formData.personality && (
                <div className="border-t border-border pt-6">
                  ...
                  <div className="text-xs text-muted-foreground leading-relaxed">
                    <MessageFormatter content={formData.personality} className="text-xs leading-relaxed chat-text" />
                  </div>
                </div>
              )}
              {formData.appearance && (
                <div className="border-t border-border pt-6">
                  ...
                  <div className="text-xs text-muted-foreground leading-relaxed">
                    <MessageFormatter content={formData.appearance} className="text-xs leading-relaxed chat-text" />
                  </div>
                </div>
              )}
              {formData.scenario && (
                <div className="border-t border-border pt-6">
                  ...
                  <div className="text-xs text-muted-foreground leading-relaxed">
                    <MessageFormatter content={formData.scenario} className="text-xs leading-relaxed chat-text" />
                  </div>
                </div>
              )}
            </div>
