...
BEGIN
    ...
    RAISE NOTICE '📊 Tables created with consistent user_id usage:';
    RAISE NOTICE '   - adventure_conversations (user_id field)';
    RAISE NOTICE '   - adventure_messages (user_id field - NULL for AI messages)';
